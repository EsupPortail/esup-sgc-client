...
public class ReadNfcTaskService extends EsupSgcTaskService {
	...
	private final static Logger log = LoggerFactory.getLogger(ReadNfcTaskService.class);
	...
	protected Task<String> createTask() {
		return ctx.getBean(ReadNfcTask.class, uiSteps, webcamImageView.imageProperty(),  bmpColorImageView, bmpBlackImageView, bmpBackImageView);
	}
